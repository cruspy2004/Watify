...
```
DATABASE_URL=postgres://postgres.YOUR_PROJECT_REF:YOUR_DB_PASSWORD@aws-0-us-east-1.pooler.supabase.com:6543/postgres
```

**Key changes:**
- Host: `aws-0-us-east-1.pooler.supabase.com` (pooler, not direct)
- Port: `6543` (transaction mode)
- User: `postgres.YOUR_PROJECT_REF` (with project ID)
